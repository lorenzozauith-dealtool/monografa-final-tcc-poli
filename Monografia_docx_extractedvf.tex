...
\usepackage{indentfirst} % Recuo no primeiro parágrafo de cada seção
\setlength{\parindent}{1.25cm} % Recuo padrão ABNT
% Ajuste de fonte para títulos (Times New Roman em todo documento)
\usepackage{times} % Fonte Times New Roman
% Reduzir negrito no sumário
\renewcommand{\cftchapfont}{\normalfont} % Capítulos sem negrito
\renewcommand{\cftsecfont}{\normalfont} % Seções sem negrito
% Traduzir títulos das listas para português
...
\begin{document}
% Forçar traduções para português (sobrescrever template politeX)
\renewcommand{\contentsname}{Sumário}
\renewcommand{\listfigurename}{Lista de Figuras}
\renewcommand{\listtablename}{Lista de Tabelas}
\capa
