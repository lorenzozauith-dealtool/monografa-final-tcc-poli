...
microcontrolador Placa Computacional, um microcontrolador Node MCU, um sensor GY-BMI160 (acelerômetro e giroscópio) e uma câmera
...
support for diagnosis or documentation. The device comprises a Placa Computacional microcontroller, an Node MCU microcontroller, a
...
e compila as informações do acidente
...
pelo funcionamento do recurso de detecção de quedas do Apple Watch.
...
detectado!”. O app assume que houve acidente real e inicia o envio de
alertas. \item Obtenção de localização: O app, ao iniciar o alerta, solicita uma leitura imediata
...
upload de ~3 MB leva em torno de 5 segundos em 4G. Caso o upload demore
ou não haja conexão, o vídeo fica armazenado localmente e é empilhado na
fila de sincronização, sendo enviado automaticamente quando a conexão for
restabelecida. \item App insere um
...
cumprindo amplamente a meta RNF-04 ($<$ 30 s). Em todos os 10 casos
testados, a notificação foi enviada com sucesso ao guardião via Telegram. \item Cobertura de Cenários: A detecção cobriu tanto
