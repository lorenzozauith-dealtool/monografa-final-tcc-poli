...
capturadas (RF-03 e RF-05): \begin{itemize} \item As \textbf{imagens/fotos} transmitidas via~BLE tinham resolução de~640x480 para caber em~<50~kB.
...
\caption{Segunda tela de detalhe da evid\^encia com detec\c{c}\~ao de placa (HQW5678) destacada em amarelo via YOLO+OCR, localiza\c{c}\~ao (Rua dos Heliotr\'opios, 237), hor\'ario diferente (14:56) demonstrando m\'ultiplos eventos.}
