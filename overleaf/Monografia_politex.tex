...
prototipagem, teste e refinamento, culminando na arquitetura final
...
\textbf{Interfaces:} I2C a 400 kHz para BMI160 (GPIO 21/22), GPIO 4 para wake-up do Placa Computacional, GPIOs 8/9 para LEDs via PWM 5 kHz, UART debug a 115200 baud (GPIO 1/3)
...
o Placa Computacional integra a arquitetura final, mantendo-se inativo na maior
...
Inicialização sob demanda: Configuramos o Placa Computacional para iniciar em
...
simplificada (a Placa Computacional era ligado junto com todo o sistema, mas em futuras
...
desligado ~0,05 W + picos esporádicos do Placa Computacional ativo), a autonomia
...
meta de 10h. Com pequenas otimizações (como desligar completamente o Placa Computacional
