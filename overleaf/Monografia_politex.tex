...
\textbf{Contribuições principais:} Desenvolvemos um sistema de detecção de acidentes que combina critérios de aceleração superior a 3,5 $g$ e inclinação superior a 65°, permitindo identificar tanto colisões frontais quanto tombamentos laterais. Implementamos arquitetura híbrida com ESP32-C3 para monitoramento contínuo de baixo consumo e Raspberry Pi Zero 2W para captura de vídeo sob demanda, otimizando autonomia energética. Integramos visão computacional com YOLO e OCR para identificação automática de placas de veículos envolvidos, funcionalidade ausente em sistemas comerciais de baixo custo. Validamos o sistema em testes controlados, atingindo n.a.\% de detecção de acidentes reais e 0\% de falsos alarmes, com tempo de resposta inferior a n.a. segundos e autonomia de n.a. horas.
