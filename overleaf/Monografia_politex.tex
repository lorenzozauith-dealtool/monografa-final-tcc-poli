...
projeto. A \textbf{árvore de objetivos} apresentada na Figura~\ref{fig:arvore} ilustra os objetivos
...
\section{Conceitos Fundamentais} A detecção de acidentes motociclísticos de forma automática requer compreender alguns conceitos fundamentais de~engenharia, apresentados de forma integrada nas subseções seguintes.
...
Descrevemos os principais módulos de hardware utilizados na implementação do~protótipo, justificando as~escolhas e~apresentando parâmetros de~configuração relevantes.
...
alerta básico chega em 28 s mesmo sem o vídeo. \item \textbf{Segurança
...
\caption{Segunda tela de detalhe da evid\^encia com detec\c{c}\~ao de placa (HQW5678) destacada via YOLO+OCR, mesma localiza\c{c}\~ao, hor\'ario diferente (14:56) demonstrando m\'ultiplos eventos registrados.}
