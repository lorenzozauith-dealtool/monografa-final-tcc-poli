...
\begin{figure}[htb]
\centering
\includegraphics[width=0.7\textwidth]{prototipo-foto1.heic}
\caption{Prot\'otipo do sistema desenvolvido - visão geral}
\label{fig:foto-prototipo}
\end{figure}

\begin{figure}[htb]
\centering
\includegraphics[width=0.7\textwidth]{prototipo-foto2.heic}
